...
| **TanStack Query (React Query)** | Server state management — fetches, caches, and auto-refreshes data; shared query keys mean the same data (e.g. doctors list) is never fetched twice on the same page |
